...
const repoRoot = require('./constants').repoRoot;
/**
 * Re-using few private methods of react-docgen to avoid code dupilcation
 */
const isRequiredPropType = require(`${repoRoot}/node_modules/react-docgen/dist/utils/isRequiredPropType`)
  .default;
const setPropDescription = require(`${repoRoot}/node_modules/react-docgen/dist/utils/setPropDescription`)
  .default;
const babylon = require(`${repoRoot}/node_modules/react-docgen/dist/babylon`)
  .default;
